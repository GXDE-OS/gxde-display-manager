    ...
    , m_model(model)
{
    ...
    connect(m_content, &LockContent::requestBackgroundFocus, this, &FullscreenBackground::setBackgroundFocused);
...
{
    // Qt6 translation: New API is XGrabKeyboard
    int requestCode = XGrabKeyboard((
        qApp->nativeInterface<QNativeInterface::QX11Application>() ?
            qApp->nativeInterface<QNativeInterface::QX11Application>()->display() : nullptr),
        winId(), true, GrabModeAsync, GrabModeAsync, CurrentTime);
