...
cc_library(
    ...
    includes = [
        ...
        "include/QtWaylandClient/6.8.2",
        "include/QtWaylandClient/6.8.2/QtWaylandClient",
        "include/QtWaylandGlobal",
        "include/QtWaylandGlobal/6.8.2",
        "include/QtWaylandGlobal/6.8.2/QtWaylandGlobal",
